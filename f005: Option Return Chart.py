...
# LONG CALLS
# Stock Info
current_price = 46.73# Current price of the security
strike = 25 # Strike price of the option 
premium = 22.0565 # Premium issued at the sale of an option at the strike
stock_range_min = 5 # Lowest stock value to model for 
stock_range_max = 200 # Highest stock value to model for 
